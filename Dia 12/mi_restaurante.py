...
# panel costos
panel_costos = Frame(panel_izquierdo, bd=5, relief=FLAT, bg='azure4', padx=70)
...
texto_costo_comida.grid(row=0, column=1, padx=43)
...
texto_costo_bebida.grid(row=1, column=1, padx=43)
...
texto_costo_postre.grid(row=2, column=1, padx=43)
...
texto_subtotal.grid(row=0, column=3, padx=43)
...
texto_impuesto.grid(row=1, column=3, padx=43)
...
texto_total.grid(row=2, column=3, padx=43)
